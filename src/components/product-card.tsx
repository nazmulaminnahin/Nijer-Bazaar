...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-card transition-all hover:-translate-y-1 hover:shadow-brand"
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        <div className="mt-auto flex items-end justify-between pt-2">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-gradient-brand px-3 py-1.5 text-xs font-bold text-primary-foreground">
            <ShoppingCart className="h-3 w-3" /> অর্ডার
          </span>
        </div>
